...
| 平台 | 命令 | 说明 |
|------|------|------|
| Web | `npx expo start` → 按 `w` | UI 测试，音频播放受限 |
| Android/iOS | Expo Go 扫码 | 完整功能测试 |
...
| **settingsStore** | theme, language, apiBaseUrl, musicQuality, showLyricTranslation, autoPlay, volume, playbackRate, customApiUrl, unblockServiceUrl, lxMusicApiUrl, enableMusicParsing | 全部 | settings.ts |
